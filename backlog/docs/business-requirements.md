...
| BR-064a | The calendar time axis must keep hour markers clear and half-hour markers subtle. | The left axis labels only full hours, uses full lines for hour rows, and uses a small notch with a dotted line for half-hour rows. | Must |
