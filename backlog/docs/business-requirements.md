...
| BR-064 | Calendar performance blocks must summarize the selected act. | A block shows compact start time as its first line, band name, stage, rating stars, and compact end time as its last line while remaining readable on a phone screen. | Must |
