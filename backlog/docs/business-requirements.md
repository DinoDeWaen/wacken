...
| BR-064b | Calendar performance blocks must visually highlight rating strength and skipped long-overlap alternatives. | A 5-star selected act uses a gold border, a 2-star selected act uses a light grey border, other selected acts keep the red accent border, and a block with a lost alternative overlapping more than 15 minutes shows broad light diagonal scratch bands in the border color family. | Must |
