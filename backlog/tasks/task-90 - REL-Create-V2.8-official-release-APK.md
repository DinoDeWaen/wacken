...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Given the V2.8 code is complete, when release validation runs, then domain, application, infrastructure, app unit tests, debug compile, and release assemble checks pass.
...
- [ ] #3 Given the release is published, when GitHub releases are viewed, then tag v2.8 contains the signed app-release.apk asset and release notes.
- [ ] #4 README documents the V2.8 release notes link and current version metadata where applicable.
...
<!-- SECTION:PLAN:BEGIN -->
1. Bump Android release metadata to versionCode 11/versionName 2.8.
2. Add V2.8 release notes and README link.
...
5. Commit and push release prep, create and push git tag v2.8.
6. Publish GitHub release v2.8 with signed app-release.apk and close the release task with validation evidence.
