...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Given the V2.4 code is complete, when release validation runs, then domain, application, infrastructure, app unit tests, debug compile, and release assemble checks pass.
...
- [ ] #3 Given the release is published, when GitHub releases are viewed, then tag v2.4 contains the signed app-release.apk asset and release notes.
- [ ] #4 README documents the V2.4 release notes link and current version metadata where applicable.
...
<!-- SECTION:PLAN:BEGIN -->
1. Update Android version metadata to 2.4.
2. Add V2.4 release notes and README link.
...
5. Commit and push release prep, create and push git tag v2.4.
...
Business requirements impact: none expected, because task-80 refined existing schedule behavior.
<!-- SECTION:PLAN:END -->
